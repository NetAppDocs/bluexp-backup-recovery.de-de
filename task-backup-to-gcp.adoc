...
Lizenzanforderungen:: Für die PAYGO-Lizenzierung für BlueXP Backup und Recovery ist im Google Marketplace ein BlueXP Abonnement verfügbar, das die Implementierung von Cloud Volumes ONTAP und BlueXP Backup und Recovery ermöglicht. Sie müssen https://["Melden Sie sich für dieses BlueXP-Abonnement an"^] Bevor Sie BlueXP Backup und Recovery aktivieren, Die Abrechnung für BlueXP Backup und Recovery erfolgt über dieses Abonnement. https://["Sie können sich auf der Seite Details  Credentials des Assistenten für die Arbeitsumgebung anmelden"^].
+
--
...
* https://["Implementieren Sie einen Connector in Google Cloud"^]
...
+
--
. In https://["Cloud Console"^], Gehen Sie zur Seite *Rollen*.
...
Siehe https://["Einführung von Cloud Volumes ONTAP in GCP"^] Anforderungen und Details für die Erstellung Ihres Cloud Volumes ONTAP Systems.
...
. Führen Sie die Seiten im Assistenten aus, um das System bereitzustellen, wie in beschrieben https://["Einführung von Cloud Volumes ONTAP in GCP"^].
