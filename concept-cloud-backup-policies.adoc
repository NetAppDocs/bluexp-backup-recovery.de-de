...
+
Sie können optional geplante Ransomware-Scans aktivieren oder deaktivieren.
...
Siehe link:manage-backup-settings-ontap.html["So aktualisieren Sie Ransomware-Schutzoptionen auf der Seite Erweiterte Einstellungen"].
