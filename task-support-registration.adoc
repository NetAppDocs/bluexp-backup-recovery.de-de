...
.Schritte
. Erstellen Sie einen NetApp Support Site Account, indem Sie den ausfüllen https://["NetApp Support Site-Formular zur Benutzerregistrierung"^]
+
...
. Navigieren Sie zu https://["Die Support-Registrierungs-Website von NetApp"^] Und wählen Sie *Ich bin kein registrierter NetApp Kunde*.
