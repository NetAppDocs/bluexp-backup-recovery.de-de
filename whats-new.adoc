...
Beachten Sie, dass die dem BlueXP Connector zugewiesenen IAM-Richtlinien den AWS-Ressourcennamen „arn“ unter allen _Resource_-Abschnitten von „aws“ in „aws-cn“ ändern müssen, z. B. „arn:aws-cn:s3:::netapp-Backup-*“. Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-to-s3.html["Backup von Cloud Volumes ONTAP Daten in Amazon S3"] und https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-aws.html["Sichern Sie On-Premises-ONTAP-Daten in Amazon S3"] .
