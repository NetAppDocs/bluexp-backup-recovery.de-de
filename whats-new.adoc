...
=== 3-2-1 Policy-Erstellung während der Backup-Aktivierung

Zuvor mussten benutzerdefinierte Richtlinien erstellt werden, bevor Sie einen Snapshot, eine Replizierung oder ein Backup initiiert haben. Ab ONTAP 9.8 P5 können Sie jetzt mithilfe der BlueXP Backup- und Recovery-UI während der Backup-Aktivierung eine Richtlinie erstellen.

https://docs.netapp.com/us-en/bluexp-backup-recovery/task-create-policies-ontap.html["Erfahren Sie mehr über Richtlinien"].



=== Unterstützung für schnelle On-Demand Restores
...
Auf dem Cloud Volumes ONTAP Zielsystem muss ONTAP Version 9.13.0 oder höher ausgeführt werden.
...
Der BlueXP Backup- und Recovery Job Monitor zeigt jetzt Informationen zu Jobs zur schnellen Wiederherstellung an.
