...
[IMPORTANT]
====
Aufgrund einer wichtigen Verbesserung der Sicherheit benötigt Ihr Connector nun ausgehenden Internetzugang auf zwei weitere Endpunkte, um Backup- und Recovery-Ressourcen in Ihrer Public Cloud-Umgebung zu verwalten. Wenn diese Endpunkte in Ihrer Firewall nicht auf die Whitelists gesetzt wurden, wird in der Benutzeroberfläche ein Fehler bezüglich „Service nicht verfügbar“ oder „Service-Status konnte nicht ermittelt werden“ angezeigt:
