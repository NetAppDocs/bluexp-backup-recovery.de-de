...
+
** Eine HTTPS-Verbindung über Port 443 zur Cloud Backup Service und zu Ihrem Google Cloud-Storage (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-google.html#endpoints-contacted-for-day-to-day-operations["Siehe die Liste der Endpunkte"^])
