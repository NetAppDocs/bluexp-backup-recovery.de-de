...
* Sie haben den On-Premises-Cluster erkannt und als Arbeitsumgebung in BlueXP hinzugefügt. Siehe https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["Erkennung von ONTAP Clustern"^] Entsprechende Details.
+
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["Installieren eines Steckers in GCP"^]
