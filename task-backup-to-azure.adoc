...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Implementieren Sie einen Connector in Azure"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-restricted-mode.html["Manuelles Installieren des Connectors auf einem Linux-Host in einer Azure-Region"^]
