...
Das Benachrichtigungscenter zeigt zahlreiche Ereignisse an, aber nur die folgenden Sicherungs- und Wiederherstellungsereignisse lösen E-Mail-Warnungen aus:
