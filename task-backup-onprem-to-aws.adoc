...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html["Installieren eines Connectors in AWS"^]
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-install-restricted-mode.html["Installieren eines Connectors in einer AWS GovCloud Region"^]
+
