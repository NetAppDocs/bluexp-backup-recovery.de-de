...
----
+
Obwohl die IP-Adresse, der Benutzername und die Passwörter benutzerdefinierte Werte sind, ist der Kontoname nicht. Der Kontoname ist immer "Account-DARKSITE1".
