...
Der indizierte Katalog v2, der im Februar 2025 veröffentlicht wurde, verfügt über neue Funktionen, die ihn effizienter und benutzerfreundlicher machen. Diese Version hat eine erhebliche Leistungssteigerung und ist standardmäßig für alle neuen Kunden aktiviert.
...
** Wenn mindestens eine Arbeitsumgebung bereits indiziert wurde, klicken Sie im Restore Dashboard unter _Suchen & Wiederherstellen_ auf *Indexierungseinstellungen*.
