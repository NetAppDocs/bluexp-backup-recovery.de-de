...
Weitere Informationen zu DataLock und Ransomware-Schutz-Anforderungen für StorageGRID, siehe link:concept-cloud-backup-policies.html["Richtlinienoptionen für das Backup an ein Objekt"].
