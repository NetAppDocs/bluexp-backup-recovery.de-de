...
StorageGRID muss folgende Anforderungen erfüllen: Siehe https://["StorageGRID-Dokumentation"^] Finden Sie weitere Informationen.
...
--
S3-Anmeldedaten:: Sie müssen ein S3-Mandantenkonto erstellt haben, um den Zugriff auf Ihren StorageGRID Storage zu kontrollieren. https://["Weitere Informationen finden Sie in der StorageGRID Dokumentation"^].
+
--
...
* Ihr StorageGRID muss sein https://["Entdeckt und verfügbar im BlueXP Canvas"^].
