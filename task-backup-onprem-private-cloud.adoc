...
[role="quick-margin-para"]
Wenn Sie bereits einen Connector in Ihrem StorageGRID oder vor Ort installiert haben, sind Sie bereit. Falls nicht, müssen Sie einen BlueXP Connector erstellen, um ONTAP Daten in StorageGRID zu sichern. Außerdem müssen Sie die Netzwerkeinstellungen für den Connector anpassen, damit er eine Verbindung zu StorageGRID herstellen kann.
...
* Wenn Sie eine kaskadierte Backup-Architektur verwenden, müssen die folgenden Einstellungen auf dem sekundären Speichersystem konfiguriert werden.
...
Die Sicherheitsgruppe der Instanz muss die erforderlichen ein- und ausgehenden Regeln enthalten: Insbesondere Regeln für ICMP und die Ports 11104 und 11105. Diese Regeln sind in der vordefinierten Sicherheitsgruppe enthalten.
...
+
Da Sie Daten zu Cloud Volumes ONTAP oder zu einem lokalen System replizieren können, prüfen Sie Peering-Anforderungen für lokale ONTAP Systeme. Siehe https://docs.netapp.com/us-en/ontap-sm-classic/peering/reference_prerequisites_for_cluster_peering.html["Anzeigen von Voraussetzungen für Cluster-Peering in der ONTAP-Dokumentation"^].
...
** *Fan Out*: Informationen fließen vom primären zum sekundären _und_ vom Quell- zum Objektspeicher.
+
