...
In BlueXP Backup und Recovery sind neun Kategorien von Endpunkten definiert:
...
Dokumentation zu den einzelnen BlueXP Backup- und Recovery-APIs ist verfügbar über https://docs.netapp.com/us-en/cloud-manager-automation/cbs/overview.html[].
